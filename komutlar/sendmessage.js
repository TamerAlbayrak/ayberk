...
exports.run = (client, message, args) => {
  if (message.author.id != "533247357878403092") return message.reply('Bunu Sadece Sahibim Kullanabilir');
...
exports.help = {
  name: 'mesajat',
  description: 'Bu komutu sadece yapımcım kullanabilir.',
  usage: 'mesajat'
};